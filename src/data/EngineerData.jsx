...
export const ENGINEER_DATA = [
  // 1. PROYECTO ACTUAL (CV)
  {
    ...
    liveLink: "https://github.com/mausashi-exe/my_cv_website_mov", // Link al repo principal si no hay deploy
...
@media screen and (max-width: 768px) {
  ...
  // 5. LIBRARY APP (Backend Placeholder based on standard stack)
  {
    id: "API_05",
    ...
    liveLink: "https://github.com/mausashi-exe/web_project_library_es",
